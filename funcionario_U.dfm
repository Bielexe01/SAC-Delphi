object funcionarios: Tfuncionarios
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT id, nome, cargo, data_contratacao, salario, telefone, end' +
        'ereco, '
      '       data_nascimento'
    ...
    object ADOQuery1data_contratacao: TDateField
