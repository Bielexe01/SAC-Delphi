object produtos: Tprodutos
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT id_produto, nome_produto, codigo_barras, preco_unitario'
      '  FROM public.produtosss;')
    Left = 800
    Top = 448
    object ADOQuery1codigo_barras: TStringField
      DisplayLabel = 'CODIGO DE BARRAS'
      DisplayWidth = 25
      FieldName = 'codigo_barras'
      Size = 50
    end
    object ADOQuery1nome_produto: TStringField
      DisplayLabel = 'PRODUTO '
      DisplayWidth = 25
      FieldName = 'nome_produto'
      Size = 255
    end
    object ADOQuery1preco_unitario: TBCDField
